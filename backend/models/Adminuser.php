...
class Adminuser  extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['adminname', 'auth_key', 'password_hash', 'email', 'created_at', 'updated_at'], 'required'],
            [['status', 'created_at', 'updated_at'], 'integer'],
            [['adminname', 'password_hash', 'password_reset_token', 'email'], 'string', 'max' => 255],
    ...
    public static function getadmininfo($id){
        return Admininfo::find()->where(['admin_id'=>$id])->one();
    }
